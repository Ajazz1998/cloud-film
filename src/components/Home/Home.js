    ...
    return(
      <div className="home-container">
        ...
        <div className="item-controller">
          ...
          <button className="item-controller__tvs wow fadeInDown" data-wow-delay=".5s" data-wow-duration="1s" onClick={() => { this.props.setItemType('TV'); this.handleTVFetch(); }}>TV Shows</button>
        </div>
